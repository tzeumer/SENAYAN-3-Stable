...
/**
 * File: lib/phpbarcode/php-barcode.php - Image-Creator/Sample
 *
 * call http://localhost/barcode.php?code=012345678901
 * or	http://localhost/barcode.php?code=012345678901&encoding=EAN&scale=4&mode=png
 * 
 * @package PHPbarcode
 * @version 0.3pl1
 */ 
